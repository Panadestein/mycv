...
\newcommand{\tableentry}[3]{\textsc{#1} & #2\expandafter\ifstrequal\expandafter{#3}{}{\\}{\\[6pt]}}
  ...
  \begin{paracol}{2}
    ...
    \item Developer of the FHI-aims software package. Enhanced the scalability of the physical models and ported them to GPUs
    \item Conceptualized new algorithms for predictive modeling. Implemented them in the open-source library of the NOMAD CoE
    \end{itemize}
