...
\photo[75pt][0.3pt]{Figures/professional_rpanades.jpg} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\cvitem{Software}{\href{https://fhi-aims.org/who-we-are}{\textcolor{unazul}{FHI-aims}} (low-scaling massively parallel GW algorithms), \href{https://www.pci.uni-heidelberg.de/tc/usr/mctdh/ref.html}{\textcolor{unazul}{MCTDH}} (Developed the SOP-FBR and SRPTucker packages), \href{https://trex-coe.eu/trex-quantum-chemistry-codes/champ}{\textcolor{unazul}{CHAMP}} (massively parallel QMC algorithms), \href{https://rxnkin.usc.es/index.php/AutoMeKin}{\textcolor{unazul}{AutoMeKin}}, MOPAC, Quantum package, MOLPRO, MOLCAS, Gaussian, Wolfram Mathematica, \href{https://panadestein.github.io/emacsd/}{\textcolor{unazul}{Emacs}}, Git, Inkscape, Libreoffice}
